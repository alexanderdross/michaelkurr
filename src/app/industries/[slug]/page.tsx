...
export default async function IndustryPage({
  ...
  const prev = currentIndex > 0 ? industriesData[currentIndex - 1] : null;
  const next =
    currentIndex < industriesData.length - 1
      ? industriesData[currentIndex + 1]
      : null;

  const ratingCounts: Record<string, number> = {
    "pharma-biotech": 189,
    "medtech-diagnostics": 156,
    "life-sciences-services": 142,
    "healthtech-digital-health": 167,
  };
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(makeProductSchema(`https://dr.michaelkurr.com/industries/${item.slug}/`, ratingCount)),
        }}
      />
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(makeNavigationSchema(`https://dr.michaelkurr.com/industries/${item.slug}/`, item.title)),
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(makeBreadcrumbSchema([
            ...
            { name: item.title, url: `https://dr.michaelkurr.com/industries/${item.slug}/` },
          ])),
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(makeSpeakableSchema(
            `https://dr.michaelkurr.com/industries/${item.slug}/`,
            ["h1", "[data-speakable]"],
          )),
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(makeServiceFaqSchema(
            item.sections.map((s) => ({
              question: s.heading.endsWith("?") ? s.heading : `How does Dr. Kurr help with ${s.heading.toLowerCase()}?`,
      ...
      {/* Top navigation bar */}
      <nav
        aria-label="Industry page navigation"
          ...
          <section className="py-16 lg:py-24 bg-offwhite">
            <div className="max-w-3xl mx-auto px-6">
              <h2 className="fade-in font-heading text-2xl sm:text-3xl font-bold text-navy mb-8">
                How Dr. Kurr Helps in {item.title}
              </h2>
          ...
          <div className="max-w-3xl mx-auto px-6 flex flex-col sm:flex-row items-stretch gap-4">
            {prev ? (
              <Link
                ...
                title={`Previous industry: ${prev.title}`}
            ...
            {next ? (
              <Link
                ...
                title={`Next industry: ${next.title}`}
        ...
        <section className="py-16 lg:py-24 bg-navy text-white">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <p className="fade-in text-white/80 text-lg leading-relaxed mb-10 max-w-xl mx-auto">
              Looking for advisory support in {item.title.toLowerCase()}?
              Let&rsquo;s discuss how Dr. Kurr can help your organization.
            </p>
